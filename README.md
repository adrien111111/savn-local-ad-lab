...
`![AD DS and DNS roles installed](screenshots/01-ad-ds-dns-roles-installed.png)` `![S1 in savn.local domain](screenshots/02-s1-in-savn-local-domain.png)` `![S1 set as domain controller](screenshots/03-s1-domain-controller.png)`
